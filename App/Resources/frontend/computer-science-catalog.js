(function () {
  ...
  var programmingFundamentals = [
    branch("Core Programming Concepts", ["Variables", "Constants", "Data Types", "Type Systems", "Type Inference", "Control Flow", "Functions", "Parameters", "Scope", "Closures", "Recursion", "Exceptions", "Error Handling", "Assertions", "Modules", "Packages", "Namespaces", "Generics", "Interfaces", "Traits", "Decorators", "Iterators", "Generators", "Pattern Matching", "Serialization", "Deserialization"]),
    branch("Object-Oriented Programming", ["Classes", "Objects", "Inheritance", "Composition", "Encapsulation", "Polymorphism", "Abstract Classes", "Interfaces", "SOLID Principles", "Dependency Injection"]),
    branch("Functional Programming", ["Pure Functions", "Higher-Order Functions", "First-Class Functions", "Function Composition", "Map and Reduce", "Immutability", "Algebraic Data Types", "Monads", "Reactive Programming"]),
    branch("Concurrency and Parallelism", ["Threads", "Thread Scheduling", "Thread Pools", "Thread-Local Storage", "Mutexes", "Locks", "Read-Write Locks", "Semaphores", "Condition Variables", "Atomics", "Race Conditions", "Deadlocks", "Livelocks", "Starvation", "Critical Sections", "Memory Ordering", "Async and Await", "Event Loops", "Futures and Promises", "Coroutines", "Actors", "Message Passing", "Work Stealing", "Parallel Algorithms", "Python Threading", "Python Asyncio", "Node Worker Threads", "JavaScript Event Loop", "Swift Concurrency", "Grand Central Dispatch", "Operation Queues", "Structured Concurrency"]),
    ...
    branch("Testing and Debugging", ["Unit Testing", "Integration Testing", "End-to-End Testing", "Property-Based Testing", "Test-Driven Development", "Mocking", "Fixtures", "Test Doubles", "Debuggers", "Breakpoints", "Logging", "Tracing", "Fuzz Testing", "Static Analysis", "Linters", "Code Coverage"])
  ];
  ...
  var artificialIntelligence = [
    ...
    branch("Generative AI", ["Large Language Models", "Tokens", "Context Windows", "Prompt Engineering", "Structured Outputs", "Function Calling", "Fine-Tuning", "Retrieval-Augmented Generation", "Vector Databases", "Embeddings", "Gemini API", "Multimodal AI", "Image Generation", "Video Generation", "Evaluation and Grounding"]),
  ...
  computerScience.children = [
    branch("Programming Fundamentals", programmingFundamentals),
    branch("Programming Languages", languages),
    branch("Data Structures", dataStructures),
    branch("Algorithms", algorithms),
    branch("Artificial Intelligence", artificialIntelligence),
    ...
    branch("Web Development", webDevelopment),
    branch("Security", security),
    branch("Cloud and DevOps", cloudAndDevOps),
  ...
  ], dataEngineering, appleAndDesktop, toolsAndWorkflow, otherFields);
})();
