(function () {
  ...
  function person(label, aliases) { return { label: label, children: [], aliases: aliases || [] }; }
  ...
  var vicePresidents = [
    ...
    "Richard Mentor Johnson (1837–1841)", "John Tyler (1841)", "George Mifflin Dallas (1845–1849)", "Millard Fillmore (1849–1850)", "William R. King (1853)",
    ...
    "Levi P. Morton (1889–1893)", "Adlai E. Stevenson I (1893–1897)", "Garret Hobart (1897–1899)", "Theodore Roosevelt (1901)",
  ...
  var famousSenators = ["Daniel Webster", "Henry Clay", "John C. Calhoun", "Charles Sumner", "Stephen A. Douglas", "Jefferson Davis", "Robert M. La Follette", "Robert M. La Follette Jr.", "Hiram Johnson", person("William E. Borah", ["Idaho William Borah", "William Borah"]), "George Norris", "Huey Long", "Robert A. Taft", "Arthur Vandenberg", "Margaret Chase Smith", "Estes Kefauver", "Richard Russell Jr.", "Lyndon B. Johnson", "Hubert Humphrey", "Everett Dirksen", "Mike Mansfield", "Jacob K. Javits", person("Edward M. Kennedy", ["Ted Kennedy"]), "Barry Goldwater", person("Daniel Patrick Moynihan", ["Pat Moynihan", "Daniel P. Moynihan"]), "Howard Baker", "George Mitchell", "Robert C. Byrd", "Sam Nunn", "John McCain", "Dianne Feinstein", "Barbara Mikulski", "Bernie Sanders", "Elizabeth Warren", "John F. Kerry", "Cory Booker", "Tammy Duckworth", "Lisa Murkowski", "Susan Collins", "Richard Nixon", "Joe Biden", "Kamala Harris", "Daniel Inouye", "Birch Bayh", "Frank Church", "J. William Fulbright", "Edmund Muskie", "Robert F. Kennedy", "Bob Dole", "Richard Lugar", "Claiborne Pell", "Lowell Weicker"];
  var famousHouseMembers = ["Frederick A. C. Muhlenberg", "Jonathan Dayton", "Nathaniel Macon", "Henry Clay", "John Quincy Adams", "Davy Crockett", "Thaddeus Stevens", "James G. Blaine", "Thomas Brackett Reed", "William Jennings Bryan", "Joseph Gurney Cannon", "Jeannette Rankin", "Fiorello La Guardia", "Sam Rayburn", "Joseph Martin Jr.", "John W. McCormack", "Gerald Ford", person("Tip O'Neill", ["Thomas P. O'Neill Jr."]), "Jim Wright", "Newt Gingrich", "Nancy Pelosi", "John Boehner", "Paul Ryan", "Steny Hoyer", "Barbara Jordan", "Shirley Chisholm", "John Lewis", "Constance Baker Motley", "Bella Abzug", "Alexandria Ocasio-Cortez", "Cynthia McKinney", "Adam Clayton Powell Jr.", "Elijah Cummings", "John Dingell", "Henry Waxman", "Ronald Dellums", "Emanuel Celler", "Hakeem Jeffries"];
  ...
  var courtCases = ["Marbury v. Madison", "McCulloch v. Maryland", "Gibbons v. Ogden", "Dred Scott v. Sandford", "Civil Rights Cases", "Plessy v. Ferguson", "Lochner v. New York", "Schenck v. United States", "Gitlow v. New York", "Brown v. Board of Education", "Mapp v. Ohio", "Gideon v. Wainwright", "Miranda v. Arizona", "Loving v. Virginia", "Tinker v. Des Moines", "New York Times Co. v. United States", "Roe v. Wade", "United States v. Nixon", "Regents of the University of California v. Bakke", "Texas v. Johnson", "Planned Parenthood v. Casey", "United States v. Lopez", "Bush v. Gore", "Lawrence v. Texas", "District of Columbia v. Heller", "Citizens United v. Federal Election Commission", "Obergefell v. Hodges", "Dobbs v. Jackson Women's Health Organization", "Scopes Trial", "Katko v. Briney", "Ossian Sweet Trial", "Sacco and Vanzetti Trials", "The Chicago Seven Trial", "Famous State Constitutional Cases", "Famous Repeated Supreme Court Cases"];
  ...
  function buildUnitedStatesPoliticalHistory() {
    ...
    return branch("U.S. Political History", [
      ...
      branch("Senate", [branch("Senate Eras", ["Early Senate", "Antebellum Senate", "Civil War and Reconstruction Senate", "Progressive Era Senate", "New Deal Senate", "Cold War Senate", "Modern Senate"]), branch("Inner Workings", senateInnerWorkings), branch("Notable Senators", famousSenators, ["Famous Senators"]), branch("Senate Elections and Representation", electionCycles.map(function (cycle) { return "Senate " + cycle; })), branch("Senate Committees and Leadership", ["Party Leaders", "Committee Chairs", "Filibuster and Cloture", "Advice and Consent"]), branch("Senate Corruption Scandals", congressionalScandals), branch("Other Senate Scandals", ["Personal Misconduct and Ethics Cases", "Lobbying and Influence", "Campaign Finance", "Other Senate Scandals"]), branch("Senate Records", ["Longest-Serving Senators", "Youngest Senators", "Senate Firsts", "Record Votes and Debates", "Historic Confirmations"])]),
      branch("House", [branch("House Eras", ["Early House", "Antebellum House", "Civil War and Reconstruction House", "Progressive Era House", "New Deal House", "Civil Rights Era House", "Modern House"]), branch("Inner Workings", houseInnerWorkings), branch("Congresses During Each Speakership", congresses.map(function (label, index) { return label + " — " + (houseSpeakersByCongress[index] || "Speakership") + " Tenure"; })), branch("Notable House Members", famousHouseMembers, ["Famous House Members"]), branch("House Elections and Representation", electionCycles.map(function (cycle) { return "House " + cycle; })), branch("House Corruption Scandals", congressionalScandals), branch("Other House Scandals", ["House Ethics Investigations", "Lobbying and Influence", "Campaign Finance", "Other House Scandals"]), branch("House Records", ["Longest-Serving Representatives", "Youngest Representatives", "House Firsts", "Historic Impeachments", "Historic Speeches"])]),
  ...
  function politicalPath() { return Array.prototype.join.call(arguments, "\u0000").toLowerCase(); }
  window.LEARNED_MEDIA_POLITICAL_AUDIT = {
    migrations: (function () {
      var migrations = {};
      migrations[politicalPath("History", "United States", "U.S. Political History", "Senate", "Famous Senators", "Thaddeus Stevens")] = ["History", "United States", "U.S. Political History", "House", "Notable House Members", "Thaddeus Stevens"];
      migrations[politicalPath("History", "United States", "U.S. Political History", "Senate", "Famous Senators", "John Lewis")] = ["History", "United States", "U.S. Political History", "House", "Notable House Members", "John Lewis"];
      migrations[politicalPath("History", "United States", "U.S. Political History", "Senate", "Famous Senators", "Ronald Reagan")] = ["History", "United States", "U.S. Political History", "Presidents", "Ronald Reagan (1981–1989)"];
      migrations[politicalPath("History", "United States", "U.S. Political History", "House", "Famous House Members", "Robert La Follette Jr.")] = ["History", "United States", "U.S. Political History", "Senate", "Notable Senators", "Robert M. La Follette Jr."];
      migrations[politicalPath("History", "United States", "U.S. Political History", "Senate", "Famous Senators", "Idaho William Borah")] = ["History", "United States", "U.S. Political History", "Senate", "Notable Senators", "William E. Borah"];
      migrations[politicalPath("History", "United States", "U.S. Political History", "Senate", "Famous Senators", "Ted Kennedy")] = ["History", "United States", "U.S. Political History", "Senate", "Notable Senators", "Edward M. Kennedy"];
      migrations[politicalPath("History", "United States", "U.S. Political History", "Senate", "Famous Senators", "Pat Moynihan")] = ["History", "United States", "U.S. Political History", "Senate", "Notable Senators", "Daniel Patrick Moynihan"];
      migrations[politicalPath("History", "United States", "U.S. Political History", "House", "Famous House Members", "Thomas P. O'Neill Jr.")] = ["History", "United States", "U.S. Political History", "House", "Notable House Members", "Tip O'Neill"];
      migrations[politicalPath("History", "United States", "U.S. Political History", "Senate", "Inner Workings", "Named Legislative Stories", "Strom Thurmond's 1998 Stem-Cell Research Testimony")] = ["History", "United States", "U.S. Political History", "Senate", "Inner Workings", "Named Legislative Stories", "Strom Thurmond's 1999 Stem-Cell Research Testimony"];
      migrations[politicalPath("History", "United States", "U.S. Political History", "Senate", "Inner Workings", "Named Legislative Stories", "Ted Kennedy, Strom Thurmond, and Stem-Cell Research")] = ["History", "United States", "U.S. Political History", "Senate", "Inner Workings", "Named Legislative Stories", "Ted Kennedy and Strom Thurmond Co-Sponsor Stem-Cell Research Protections (2002)"];
      migrations[politicalPath("History", "United States", "U.S. Political History", "Senate", "Inner Workings", "Named Legislative Stories", "Ted Kennedy's 2006 Stem-Cell Research Floor Push")] = ["History", "United States", "U.S. Political History", "Senate", "Inner Workings", "Named Legislative Stories", "Ted Kennedy and Strom Thurmond Co-Sponsor Stem-Cell Research Protections (2002)"];
      return migrations;
    })(),
    labelMigrations: {
