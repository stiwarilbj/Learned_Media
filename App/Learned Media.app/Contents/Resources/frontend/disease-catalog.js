(function () {
  ...
  var respiratory = ["COVID-19", "Influenza", "Common Cold", "Respiratory Syncytial Virus", "SARS", "MERS", "Tuberculosis", "Pertussis", "Diphtheria", "Pneumonia", "Legionnaires' Disease", "Pneumocystis Pneumonia", "Histoplasmosis", "Coccidioidomycosis", "Blastomycosis", "Aspergillosis", "Hantavirus Pulmonary Syndrome", "Lungworm Disease", "Silicosis", "Asbestosis"];
  var skin = ["Smallpox", "Mpox (Monkeypox)", "Chickenpox", "Measles", "Rubella", "Hand, Foot, and Mouth Disease", "Molluscum Contagiosum", "Warts and Human Papillomavirus", "Impetigo", "Leprosy", "Erysipelas", "Ringworm", "Candidiasis of the Skin", "Scabies", "Cutaneous Leishmaniasis", "Sporotrichosis", "Chromoblastomycosis", "Mycetoma", "Anthrax of the Skin", "Necrotizing Fasciitis"];
  var neurological = ["Polio", "Rabies", "Tetanus", "Meningococcal Disease", "Viral Meningitis", "Encephalitis", "Japanese Encephalitis", "West Nile Neuroinvasive Disease", "Herpes Simplex Encephalitis", "Neurocysticercosis", "African Sleeping Sickness", "Creutzfeldt-Jakob Disease", "Variant Creutzfeldt-Jakob Disease", "Kuru", "Fatal Familial Insomnia", "Toxoplasmosis of the Brain"];
  var digestive = ["Cholera", "Typhoid Fever", "Paratyphoid Fever", "Salmonellosis", "Shigellosis", "Campylobacteriosis", "Listeriosis", "Norovirus Infection", "Rotavirus Infection", "Hepatitis A", "Hepatitis E", "Amebiasis", "Giardiasis", "Cryptosporidiosis", "Intestinal Worm Infections", "Botulism", "Food Poisoning", "Clostridioides difficile Infection", "Whipple Disease"];
  var blood = ["HIV Infection and AIDS", "Hepatitis B", "Hepatitis C", "Malaria", "Babesiosis", "Chagas Disease", "Dengue", "Yellow Fever", "Ebola Disease", "Marburg Virus Disease", "Lassa Fever", "Crimean-Congo Hemorrhagic Fever", "Plague", "Brucellosis", "Tularemia", "Lyme Disease", "Visceral Leishmaniasis", "Lymphatic Filariasis"];
  var fever = ["Influenza", "Malaria", "Dengue", "Chikungunya", "Yellow Fever", "Typhoid Fever", "Relapsing Fever", "Q Fever", "Rocky Mountain Spotted Fever", "Rheumatic Fever", "Scarlet Fever", "Lassa Fever", "Marburg Virus Disease", "Ebola Disease", "Crimean-Congo Hemorrhagic Fever", "West Nile Fever", "Japanese Encephalitis", "Zika Virus Disease", "Chagas Disease"];

  var viral = [
    branch("Respiratory Viruses", respiratory),
    ...
    branch("Viral Diseases of the Nervous System", ["Polio", "Rabies", "Viral Meningitis", "Encephalitis", "Japanese Encephalitis", "West Nile Neuroinvasive Disease", "Herpes Simplex Encephalitis"]),
  ...
  var prions = ["Creutzfeldt-Jakob Disease", "Variant Creutzfeldt-Jakob Disease", "Kuru", "Fatal Familial Insomnia", "Gerstmann-Sträussler-Scheinker Syndrome", "Bovine Spongiform Encephalopathy", "Chronic Wasting Disease", "Scrapie"];
  var transmission = [
    branch("Airborne and Respiratory Spread", respiratory.concat(["Measles", "Chickenpox", "Tuberculosis", "COVID-19", "Influenza"])),
    branch("Fecal-Oral and Waterborne Spread", digestive.concat(["Hepatitis A", "Hepatitis E", "Cholera", "Polio"])),
    ...
    branch("Bloodborne Spread", blood.concat(["Hepatitis B", "Hepatitis C", "HIV Infection and AIDS", "Malaria", "Babesiosis"])),
  ...
  var bodySystems = [
    branch("Respiratory System", respiratory), branch("Digestive System", digestive),
    ...
    branch("Nervous System", neurological), branch("Skin and Hair", skin),
  ...
  var effects = [
    branch("Fever and Chills", fever), branch("Rashes and Skin Changes", skin), branch("Breathing Problems", respiratory), branch("Digestive Symptoms", digestive),
    ...
    branch("Brain and Nerve Effects", neurological), branch("Long-Term and Chronic Effects", ["HIV Infection and AIDS", "Long COVID", "Post-Polio Syndrome", "Chronic Hepatitis", "Rheumatic Heart Disease", "Post-Tuberculosis Lung Disease", "Chronic Chagas Disease", "Post-Infectious Encephalitis"])
  ];
  var impact = [
  ...
  function diseases() {
    return branch("Diseases", [
      branch("Viruses & Diseases", [
        branch("By Causative Agent", [branch("Viral Diseases", viral), branch("Bacterial Diseases", bacterial), branch("Fungal Diseases", fungal), branch("Parasitic Diseases", parasitic), branch("Prion Diseases", prions)]),
        branch("By How They Spread", transmission), branch("By Body System", bodySystems), branch("By Main Effects", effects),
        ...
        branch("Impact of Disease on Society", impact),
      ...
      branch("Pandemics & Epidemics", [branch("By Time Span", pandemicsByTime), branch("By Type", pandemicsByType), branch("Public Health Response", ["Quarantine", "Isolation", "Contact Tracing", "Vaccination Campaigns", "Masking and Respiratory Protection", "Travel Measures", "Emergency Declarations", "International Health Regulations", "Community Response", "Pandemic Preparedness"]), branch("How Outbreaks Spread", ["Animal Spillover", "Respiratory Spread", "Water and Sanitation", "Foodborne Spread", "Vector Expansion", "Global Travel", "Crowded Housing", "Healthcare Transmission", "Misinformation During Outbreaks"])] )
    ]);
  }

  var science = catalog.filter(function (item) { return item.label === "Science"; })[0];
  if (science && !science.children.some(function (item) { return item && item.label === "Diseases"; })) science.children.splice(2, 0, diseases());
})();
