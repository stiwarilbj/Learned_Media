...
ARM_BIN="$(swift build -c release --arch arm64 --show-bin-path)/LearnedMediaApp"
swift build -c release --arch x86_64
INTEL_BIN="$(swift build -c release --arch x86_64 --show-bin-path)/LearnedMediaApp"
...
lipo -create "$ARM_BIN" "$INTEL_BIN" -output "$MACOS_DIR/LearnedMediaApp"
...
<dict>
  ...
  <key>CFBundleURLTypes</key><array><dict><key>CFBundleURLSchemes</key><array><string>learnedmedia</string></array></dict></array>
</dict>
</plist>
PLIST
